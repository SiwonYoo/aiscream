...
export default function EditorPlaceholder() {
  return (
    <div className="base mx-auto flex h-full w-full flex-1 flex-col items-center justify-center gap-6 px-4 pc:max-w-300">
      <StarIcon className="w-15 text-black pc:w-17.5" />
