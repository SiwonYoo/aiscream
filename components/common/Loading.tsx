...
export default function Loading({ autoplay = true, loop = true }: Props) {
  return (
    <div className="absolute top-0 right-0 bottom-0 left-0 z-1 flex flex-col items-center justify-center gap-6 bg-black/40 dark:bg-white/60">
      ...
      <p className="animate-pulse text-center text-base text-white pc:text-lg dark:text-black">
        블로그를 작성중입니다.
        <br />
        조금만 기다려주세요.
      </p>
